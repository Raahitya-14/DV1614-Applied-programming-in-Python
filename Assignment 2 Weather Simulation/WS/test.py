...
def check_formalities(transitions, holding_time):
    ...
    # Check methods set_holding_time_in_state', 'current_state', 'current_state_staying_hours',
    # 'current_state_remaining_hours', 'next_state', 'iterable', 'simulate']
    methods = ['get_states', 'set_state', 'current_state', 'current_state_remaining_hours', 'next_state', 'iterable',
               'simulate']
...
def check_exception(wrong_transitions, holding_time):
    ...
    try:
        ...
        print(f'Exception raised (correctly) with details:')
        result = False
    else:
        result = False
